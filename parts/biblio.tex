...
\tcitebullet Loïc Paulevé, Morgan Magnin, Olivier Roux. \emphcolor{Refining dynamics of gene regulatory networks in a stochastic $\pi$-calculus framework}. In Corrado Priami, Ralph-Johan Back, Ion Petre, and Erik de Vink, editors: \textit{Transactions on Computational Systems Biology XIII}, volume 6575 of Lecture Notes in Computer Science, pages 171--191, 2011.

\tcitebullet Loïc Paulevé, Morgan Magnin, Olivier Roux. \emphcolor{Static analysis of biological regulatory networks dynamics using abstract interpretation}. \textit{Mathematical Structures in Computer Science}, 2012.

%\tcitebullet Adrien Richard, Jean-Paul Comet, Gilles Bernot. \emphcolor{R. Thomas' logical method}, 2008. Invited at \textit{Tutorials on modelling methods and tools: Modelling a genetic switch and Metabolic Networks}, Spring School on Modelling Complex Biological Systems in the Context of Genomics.
...
\tcitebullet Paul François, Vincent Hakim, Eric D Siggia. \emphcolor{Deriving structure from evolution : metazoan segmentation}.
