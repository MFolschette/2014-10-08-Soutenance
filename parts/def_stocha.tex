...
\begin{frame}[c]
  \frametitle{Paramètres stochastiques}
  \framesubtitle{\tcite{\cpmrtcsb}}

\begin{itemize}
  \item Introduction de propriétés temporelles
  \item Paramètres stochastiques $(r,sa)$ équivalents à un \tval{intervalle de tir} $[d;D]$
\end{itemize}
...
\noindent
\f \tval{Probabilité très faible} d'atteindre $b_1$
}
...
% \end{fleches}
\begin{itemize}
  \item Simulation \f non formel
  \item \textit{Model-checking} \f forte complexité pour une précision acceptable
\end{itemize}
